...
def main():
    ...
    save_executive_report_by_scan_id(first_product["scans"][0]["id"])
    save_executive_details_report_by_scan_id(first_product["scans"][0]["id"])
    save_engineering_report_by_scan_id(first_product["scans"][0]["id"])
